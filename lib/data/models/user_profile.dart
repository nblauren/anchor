...
class UserProfile extends Equatable {
  const UserProfile({
    ...
    required this.name,
    required this.age,
    required this.createdAt, required this.updatedAt, this.bio,
  ...
  factory UserProfile.fromJson(Map<String, dynamic> json) {
    return UserProfile(
      ...
      photoUrls: List<String>.from((json['photoUrls'] as Iterable?) ?? []),
      interests: List<String>.from((json['interests'] as Iterable?) ?? []),
