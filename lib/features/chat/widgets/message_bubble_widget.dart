    ...
    return Align(
      ...
      child: Column(
        ...
        children: [
          ...
          if (quotedMessage != null) _buildFloatingQuoteCard(context, maxWidth),
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: contentType == MessageContentType.photo
                          // Photo fills the entire bubble; timestamp overlays bottom-right.
                          ? Stack(
                              children: [
                          ...
                          : Column(
                              ...
                              children: [
                                if (contentType ==
                                    MessageContentType.photoPreview)
                                ...
                                Padding(
                                  padding: EdgeInsets.only(
                                    ...
                                    right: 12,
                                    bottom: 8,
                                    top: contentType != MessageContentType.text
                                        ? 8
                                        : 0,
                                  ),
                                  child: Row(
    ...
    switch (message.status) {
      ...
      case MessageStatus.read:
        return const Icon(
          ...
          size: 16,
          color:
              Color(0xFF4FC3F7), // light blue — distinct from delivered white
        );
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            _formattedSize.isNotEmpty ? 'Photo ($_formattedSize)' : 'Photo',
            style: const TextStyle(
              color: Colors.white,
